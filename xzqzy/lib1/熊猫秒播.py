...
class Spider(Spider):
    ...
    def detailContent(self, ids):
        ...
        json_dict = json.loads(res.text)
        if svid == "10":
            purl = js1['data']['macVodLinkMap']['10']['LINK_2'] + json_dict['data']["result"]["vod_url"]
        elif svid == "11":
            purl = js1['data']['macVodLinkMap']['11']['LINK_2'] + json_dict['data']["result"]["vod_url"]
        elif svid == "12":
            purl = js1['data']['macVodLinkMap']['12']['LINK_2'] + json_dict['data']["result"]["vod_url"]
        elif svid == "13":
            purl = js1['data']['macVodLinkMap']['13']['LINK_2'] + json_dict['data']["result"]["vod_url"]
        elif svid == "14":
            purl = js1['data']['macVodLinkMap']['14']['LINK_2'] + json_dict['data']["result"]["vod_url"]
        else:
    ...
    def playerContent(self, flag, id, vipFlags):
        result = {}
        result["parse"] = 0
        result["playUrl"] = 'https://server15.dzlndygh.com'
        result["url"] = id
